								...
								<div class="card-box">
									<h4 class="m-t-0 m-b-30 header-title"><i class="fa fa-list"></i> Data API</h4>
										...
										<table class="table table-striped table-bordered table-hover" id="datatable">
											...
											<a href="/cron/service.php" class="btn btn-sm btn-success"><i class="fa fa-plus"></i></a>
											</a>
											<a href="/cron/dellete.php" class="btn btn-sm btn-danger"><i class="fa fa-close"></i></a>
													</td>
												</tr>
											<?php
											}
