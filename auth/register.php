							...
							<div class="offset-lg-3 col-lg-6">
								<div class="card-box">
									...
									<form class="form-horizontal" method="post">
										...
										<div class="form-group">
											<label>Email Aktif</label><input type="email" class="form-control" name="email">
										</div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                        		<label><input type="checkbox" name="terms" > Saya setuju dengan <a href="/page/tos.php">Ketentuan Layanan</a>.</label>
                                        	</div>
										<div class="form-group">
												<button class="btn btn-primary btn-block" type="submit"><i class="fa fa-check"></i> Daftar</button>
										</div>
									</form>
									<p class="text-center">
                                    	Sudah Punya Akun? <a href="/auth/login">Klik Disini</a>
                                    </p>
								</div>
							</div>
						</div>
