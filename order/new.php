		...
		if (check_empty($validation) == true) {
			...
			if ($service['count'] == 0) {
				...
				if ($provider['count'] == 0) {
					...
					$curl = '';
					$provider_order_id = '4';
					if ($service['rows']['provider_id'] == '4') { // ZAYNFLAZZ
                        $post_api = array(
							'api_key' => $provider['rows']['api_key'],
							'action' => 'pemesanan',
							'layanan' => $service['rows']['provider_service_id'],
							'target' => $_POST['data'],
					...
					} else if ($service['rows']['provider_id'] == '1') { // ZAYNFLAZZ
						$post_api = array(
...
?>
	...
	<div class="form-group">
			<button class="btn btn-primary btn-block" type="submit"><i class="fa fa-check"></i> Submit</button>
	</div>
</form>
								</div>
							</div>
							<div class="col-lg-4">
                                ...
                                </p><li>Pilih salah satu Kategori.</li>
                                ...
                                Jika terjadi kesalahan / mendapatkan pesan gagal yang kurang jelas, silahkan hubungi Admin untuk informasi lebih lanjut.</li>
                                 ...
                                 <li>Jangan memasukkan orderan yang sama di panel lain jika orderan di <?php echo $config['web']['short_title'] ?> belum selesai. </li>
                                 ...
                                 <li>Jika Anda memasukkan orderan di <?php echo $config['web']['short_title'] ?> berarti Anda sudah mengerti aturan <?php echo $config['web']['short_title'] ?> dan jangan lupa baca menu F.A.Q serta Terms </li>
                                			<p></p>
                                		</div>
									</p>
								</div> 
