            ...
            <div class="container-fluid">
                <div class="logo">
                    <a href="<?php echo $config['web']['base_url'] ?>" class="logo">
                        ...
                        <span class="logo-large"><i class="fa fa-shopping-cart"></i> <?php echo $config['web']['short_title'] ?></span>
                    </a>
                </div>
                    ...
                    <ul class="navigation-menu">
                        ...
                        ?>
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li><a href="/ticket/submit">Tiket</a></li>
                                    <li><a href="/ticket/">Riwayat Tiket</a></li>
                                </ul>
                            </li>
                            <li>
