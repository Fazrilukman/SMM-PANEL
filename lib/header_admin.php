...
.border-custom {
        ...
        .bg-custom {
            background-color: #5c78db !important;
        }
</style>
	</head>
	<body>
	<header id="topnav">
			<div class="topbar-main">
				<div class="container-fluid">
					<div class="logo">
                        ...
                        <span class="logo-large"><i class="fa fa-shopping-cart"></i>HALAMAN ADMIN</span>
						</a>
					</div>
			...
			<div class="navbar-custom" style="background: linear-gradient(to right, #6d8ad7, #657fda, #6174db, #6068db, #625ada);">
				<div class="container-fluid">
					<div id="navigation">
						...
						<li class="has-submenu">
							...
							<ul class="submenu">
								<li><a href="<?php echo $config['web']['base_url'] ?>admin">Halaman Admin</a></li>
								<li><a href="<?php echo $config['web']['base_url'] ?>">Halaman Pengguna</a></li>
							</ul>
						</li>
						<li>
